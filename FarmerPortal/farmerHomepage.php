      ...
      <body>
           ...
           <nav class="navbar navbar-expand-xl ">
                ...
                <div class=" flex-row-reverse left ">
                    ...
                    <a href="CartPage.php"> <i class="fa" style=" color:green ;font-size:20px;margin-top:-20px;margin-bottom:20px;">&#61562;</i></a> -->
                     ...
                     <a class="float-left" href="#">
                          <img src="C:\Users\Harshvardhan\OneDrive\Desktop\webathon\FarmBuy\FarmerPortal\agro.jpg" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
                     </a>
                </div>
                ...
                <a class="float-left" href="farmerHomepage.php">
                     <img src="../Images/Homepage/agro.jpg" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
                </a>
                ...
                <div class="container">
                     ...
                     <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                               <p><u>FarmBuy Corporation</u> is a Multitrading Company for farmers ang traders</p>
                               <p class="h6">Copy All right Reversed.FarmBuyTech</p>
                          </div>
                          </hr>
                     </div>
                </div>
